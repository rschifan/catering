...
A worked reference for the **Sviluppo e Architettura del Software t1** course at the University of Turin. The implementation covers the *Gestire menù* and *Gestire compiti cucina* use cases and applies five patterns from the curriculum: **Singleton**, **Composite**, **Strategy**, **Observer**, and **Pure Fabrication** (GRASP).
